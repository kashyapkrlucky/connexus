...
export function SideBar({ children, className }: SideBarProps) {
  ...
  return (
    // No fixed height: the column stretches with the page so its divider runs full length,
    // while the contents stick below the top bar on desktop.
    <aside className={cn("w-72 shrink-0 border-r border-border/40 p-3", className)}>
      <div className="space-y-3 lg:sticky lg:top-17">
